...
declare module wx {
    ...
    export module types {
        ...
        type SetScreenBrightnessParams = {
            success?:() => void,
            fail?:() => void,
            complete?:() => void,
            /**
...
declare module wx {
     ...
     * 创建一个图片对象
     */
    export function createImage():wx.types.Image;
    
    /**
     * 获取一行文本的行高
     * @param p 字体参数
     */
    export function getTextLineHeight(p:wx.types.LineHeightParams):number;
    ...
    //--生命周期
    export function exitMiniProgram(cb?:wx.types.Callbacks):void;
    export function getLaunchOptionsSync():wx.types.LaunchOption;
    export function onHide(cb:() => void):void;
    export function offHide(cb:() => void):void;
    export function onShow(cb:(res:{ scene:string, query:any, shareTicket:string }) => void):void;
    export function offShow(cb:(res:{ scene:string, query:any, shareTicket:string }) => void):void;
    
    //--系统信息
    export function getSystemInfo(cb:wx.types.CallbacksWithType<wx.types.SystemInfo>):void;
    export function getSystemInfoSync():wx.types.SystemInfo;
     ...
     * 监听全局错误事件
     */
    export function onError(cb:(res:{ message:string, stack:string }) => void):void;
    export function offError(cb:(res:{ message:string, stack:string }) => void):void;

    //--触摸事件
    /**
     * 监听开始始触摸事件
     */
    export function onTouchStart(cb:(res:wx.types.TouchData) => void):void;
    export function offTouchStart(cb:(res:wx.types.TouchData) => void):void;
    /**
     * 监听触点移动事件
     */
    export function onTouchMove(cb:(res:wx.types.TouchData) => void):void;
    export function offTouchMove(cb:(res:wx.types.TouchData) => void):void;
    /**
     * 监听触摸结束事件
     */
    export function onTouchEnd(cb:(res:wx.types.TouchData) => void):void;
    export function offTouchEnd(cb:(res:wx.types.TouchData) => void):void;
    /**
     * 监听触点失效事件
     */
    export function onTouchCancel(cb:(res:wx.types.TouchData) => void):void;
    export function offTouchCancel(cb:(res:wx.types.TouchData) => void):void;

    //--加速计
    /**
     * 监听加速度数据，频率：5次/秒，接口调用后会自动开始监听，可使用 wx.stopAccelerometer 停止监听。
     */
    export function onAccelerometerChange(cb:(res:{ x:number, y:number, z:number }) => void):void;
    /**
     * 开始监听加速度数据。
     */
    export function startAccelerometer(cb:wx.types.AccelerometerParams):void;
    /**
     * 停止监听加速度数据。
     */
    export function stopAccelerometer(cb?:wx.types.Callbacks):void;
    
    //--电量
    /**
     * 获取设备电量。同步 API wx.getBatteryInfoSync 在 iOS 上不可用。
     */
    export function getBatteryInfo(cb:wx.types.CallbacksWithType<wx.types.BatteryInfo>):void;
    /**
     * IOS上这个同步API无法使用
     */
    export function getBatteryInfoSync():wx.types.BatteryInfo;
    
    //--剪贴板
    /**
     * 取得系统剪贴板的内容
     */
    export function getClipboardData(cb:wx.types.CallbacksWithType<wx.types.ClipboardData>):void;
    /**
     * 设置系统剪贴板的内容
     */
    export function setClipboardData(p:wx.types.SetClipboardDataParams):void;
     ...
     */
    export function onCompassChange(cb:(res:{ direction: number }) => void):void;
    /**
     * 开始监听罗盘数据
     */
    export function startCompass(cb?:wx.types.Callbacks):void;
    /**
     * 停止监听罗盘数据
     */
    export function stopCompass(cb?:wx.types.Callbacks):void;

    //--网络
    /**
     * 获取网络类型
     */
    export function getNetworkType(cb:wx.types.CallbacksWithType<{ isConnected:boolean, networkType:wx.types.NetworkType }>):void;
    /**
     * 监听网络状态变化事件
     */
    export function onNetworkStatusChange(cb:(res:{
        /**
         * 当前是否有网络链接
         */
        isConnected: boolean,
         ...
         */
        networkType: wx.types.NetworkType
    }) => void):void;
     ...
     * 获取屏幕亮度
     */
    export function getScreenBrightness(cb:wx.types.CallbacksWithType<{ value:number }>):void;
    /**
     * 设置是否保持常亮状态。仅在当前小程序生效，离开小程序后设置失效。
     */
    export function setKeepScreenOn(p:wx.types.SetKeepScreenOnParams):void;
    /**
     * 设置屏幕亮度
     */
    export function setScreenBrightness(p:wx.types.SetScreenBrightnessParams):void;

    //--转屏
    /**
     * 监听横竖屏切换事件
     */
    export function onDeviceOrientationChange(callback:(res:{ value:string }) => void):void;
    /**
     * 取消监听横竖屏切换事件
     */
    export function offDeviceOrientationChange(callback:(res:{ value:string }) => void):void;

    //--振动
    /**
     * 使手机发生较短时间的振动（15 ms）
     */
    export function vibrateShort(cb?:wx.types.Callbacks):void;
    /**
     * 使手机发生较长时间的振动（400 ms)
     */
    export function vibrateLong(cb?:wx.types.Callbacks):void;
     ...
     * 下载文件
     */
    export function downloadFile(param:wx.types.DownfileParams):DownloadTask;

    //--发起请求
    export function request(param:wx.types.RequestParams):RequestTask;

    //--websocket
    /**
     * 创建一个 WebSocket 连接。最多同时存在 5 个 WebSocket 连接。
     */
    export function connectSocket(param:wx.types.SocketConnectParams):SocketTask;
    /**
     * 关闭WebSocket
     */
    export function closeSocket(param:wx.types.SocketCloseParams):void;
    /**
     * 监听WebSocket 连接打开事件
     */
    export function onSocketOpen(callback:wx.types.SocketOpenCallback):void;
    /**
     * 监听WebSocket 连接关闭事件
     */
     ...
     * 监听WebSocket 接受到服务器的消息事件
     */
    export function onSocketMessage(callback:wx.types.SocketMessageCallback):void;
    /**
     * 监听WebSocket 错误事件
     */
    export function onSocketError(callback:wx.types.SocketErrorCallback):void;
    /**
     * 通过 WebSocket 连接发送数据，需要先 wx.connectSocket，并在 wx.onSocketOpen 回调之后才能发送。
     */
    export function sendSocketMessage(param:wx.types.SocketSendParams):void;
     ...
     */
    export function getFriendCloudStorage(param:{
        /**
         * 要拉取的 key 列表
         */
        keyList:string[],
     ...
     */
    export function getUserCloudStorage(param:{
        /**
         * 要拉取的 key 列表
         */
        keyList:string[],
     ...
     */
    export function getGroupCloudStorage(param:{
        /**
         * 群分享对应的 shareTicket
         */
        shareTicket:string,
     ...
     */
    export function removeUserCloudStorage(param:{
        /**
         * 要删除掉 key 列表
         */
        keyList:string[],
     ...
     */
    export function setUserCloudStorage(param:{
        /**
         * 要修改的 KV 数据列表
         */
        KVDataList:KVData[],
     ...
     */
    export function checkSession(cb:wx.types.Callbacks):void;
    /**
     * 调用接口获取登录凭证（code）进而换取用户登录态信息，包括用户的唯一标识（openid） 及本次登录的 会话密钥（session_key）等。用户数据的加解密通讯需要依赖会话密钥完成。
     */
    export function login(cb:wx.types.CallbacksWithType<{
        /**
     ...
     */
    export function checkIsUserAdvisedToRest(param:{
        /**
         * 今天已经玩游戏的时间，单位：秒
         */
    ...
    //--用户信息
    export function createUserInfoButton(param:{
        /**
         * 按钮类型
         */
    ...
    /**
     * @deprecated 该接口已过期，微信不允许主动弹出授权框，该API会被逐渐作废，请使用wx.createUserInfoButton和在隔离数据区取得用户信息
     ...
     * 创建打开设置页面的按钮
     */
    export function createOpenSettingButton(type:wx.types.ButtonType, text:string, image:string, style:wx.types.ButtonStyle):OpenSettingButton;
    /**
     ...
     */
    export function getWeRunData(p:wx.types.CallbacksWithType<{
        /**
     ...
     */
    export function createGameClubButton(param:{
        type:wx.types.ButtonType,
        text:string,
        image:string,
        style:wx.types.ButtonStyle,
     ...
     * 用户点击后打开意见反馈页面的按钮
     */
    export function createFeedbackButton(param:{
        type:wx.types.ButtonType,
        text:string,
        image:string,
        style:wx.types.ButtonStyle
     ...
     */
    export function openCustomerServiceConversation(param:{
        /**
         * 会话来源
         */
        sessionFrom?:string,
     ...
     * 获取转发详细信息
     */
    export function getShareInfo(param:{
        shareTicket:string,
        success?:(res:{
            /**
             * 错误信息
     ...
     * 隐藏转发按钮
     */
    export function hideShareMenu(cb?:wx.types.Callbacks):void;
    /**
     * 监听用户点击右上角菜单的“转发”按钮时触发的事件
     */
    export function onShareAppMessage(cb:(data:wx.types.ShareOption) => void):void;
    /**
     * 取消监听用户点击右上角菜单的“转发”按钮时触发的事件
     */
    export function offShareAppMessage(cb:(data:wx.types.ShareOption) => void):void;
    /**
     * 显示当前页面的转发按钮
     */
     ...
     * 主动拉起转发，进入选择通讯录界面。
     */
    export function shareAppMessage(param:wx.types.ShareOption):void;
    /**
     * 更新转发属性
     */
    export function updateShareMenu(param:{
        /**
     ...
     * 获取性能管理器
     */
    export function getPerformance():WxPerformance;
    /**
    ...
    //--调试
    export function setEnableDebug(p:{
        enableDebug:boolean,
        success?:() => void,
        fail?:() => void,
        complete?:() => void
     ...
     * 清理本地数据缓存
     */
    export function clearStorage(param:wx.types.Callbacks):void;
    /**
     * clearStorage的同步版本
     */
     ...
     */
    export function getStorage(param:wx.types.GetStorageParams):void;
    /**
     * getStorage 的同步版本
     */
    export function getStorageSync(key:string):string | any;
    /**
     * 异步获取当前storage的相关信息
     */
    export function getStorageInfo(param:wx.types.CallbacksWithType<wx.types.StorageInfo>):void;
    /**
     * getStorageInfo 的同步版本
     */
    export function getStorageInfoSync():wx.types.StorageInfo;
    /**
     * 从本地缓存中移除指定 key
     */
    export function removeStorage(param:wx.types.RemoveStorageParams):void;
    /**
     * removeStorage 的同步版本
     ...
     */
    export function setStorage(param:wx.types.SetStorageParams):void;
    /**
     * setStorage 的同步版本
     * @param key 本地缓存中指定的 key
     * @param data 需要存储的内容
     ...
     * 触发分包加载，详见 分包加载
     */
    export function loadSubpackage(param:{
        /**
    ...
    export function setMenuStyle(param:{
        /**
         * 样式风格
         */
        style:"light" | "dark",
     ...
     * 隐藏消息提示框
     */
    export function hideToast(cb?:wx.types.Callbacks):void;
    /**
     * 显示模态对话框
     */
    export function showModal(param:{
        /**
         * 提示的标题
         */
        title:string,
     ...
     */
    export function showLoading(prms?:{
        /**
         * 提示的内容
         */
        title:string,
     ...
     * 隐藏 loading 提示框
     */
    export function hideLoading(cb?:wx.types.Callbacks):void;
    /**
     * 显示选择器
     */
     ...
     */
    export function onKeyboardInput(callback:(res:{ value:string }) => void):void;
    /**
     * 取消监听键盘输入事件
     */
    export function offKeyboardInput(callback:(res:{ value:string }) => void):void;
    /**
     * 监听用户点击键盘 Confirm 按钮时的事件
     * @param callback.res.value 键盘输入的当前值
     */
    export function onKeyboardConfirm(callback:(res:{ value:string }) => void):void;
    /**
     * 取消监听用户点击键盘 Confirm 按钮时的事件
     */
    export function offKeyboardConfirm(callback:(res:{ value:string }) => void):void;
    /**
     * 监听监听键盘收起的事件
     * @param callback.res.value 键盘输入的当前值
     */
    export function onKeyboardComplete(callback:(res:{ value:string }) => void):void;
    /**
     * 取消监听监听键盘收起的事件
     */
    export function offKeyboardComplete(callback:(res:{ value:string }) => void):void;
    /**
     * 显示键盘
     */
    export function showKeyboard(param:{
        /**
         * 键盘输入框显示的默认值
         */
        defaultValue:string,
     ...
     */
    export function updateKeyboard(param:{
        /**
         * 键盘输入框的当前值
         */
        value:string,
     ...
     * 监听窗口尺寸变化事件
     */
    export function onWindowResize(cb:(res:{ windowWidth:number, windowHeight:number }) => void):void;
    /**
     * 取消监听窗口尺寸变化事件
     */
    export function offWindowResize(cb:(res:{ windowWidth:number, windowHeight:number }) => void):void;
     ...
     */
    export function createWorker():WxWorker;
     ...
     * 获取当前支持的音频输入源
     */
    export function getAvailableAudioSources(param:wx.types.CallbacksWithType<{
        /**
         * 音频输入源，每一项对应一种音频输入源
         */
        audioSources:wx.types.AudioSourceType[]
    }>):void;
     ...
     */
    export function saveImageToPhotosAlbum(param:{
        /**
     ...
     */
    export function createBannerAd(param:{
        /**
         * 广告单元 id
         */
        adUnitId:string,
     ...
     */
    export function createRewardedVideoAd(param:{
        /**
         * 广告单元 id
         */
        adUnitId:string
     ...
     * 发起米大师支付
     */
    export function requestMidasPayment(param:{
        /**
